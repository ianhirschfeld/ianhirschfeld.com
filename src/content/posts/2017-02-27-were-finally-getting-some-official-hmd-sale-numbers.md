...
All-in-all we are looking at roughly 6.8 million mobile to high-end HMDs out on the market, and this doesn’t include Google Cardboard, OSVR, and other secondary HMDs in markets such as China. The best part is, we know exactly what we need to do to get these numbers to continue to grow: keep lowering the barrier of entry to HMDs and create compelling content / apps that drive usage.

I foresee continued growth from the Gear VR, Daydream, and PSVR due to their high accessibility and affordability. Meanwhile, I see the Vive and Rift growing slowly as a majority of developers and VR enthusiasts already purchased these HMDs. I don’t expect mass market consumers buying into high-end VR until it is less expensive, has smaller/lighter industrial design, and doesn’t require a high-end PC. I’m excited to see what comes of Windows 10 compatible HMDs as they potentially serve the same market as PSVR.

_Ian Hirschfeld is the CEO of_ [_The Soap Collective_](http://www.thesoapcollective.com/)_, a virtual reality creative agency and content studio building premium interactive experiences._
