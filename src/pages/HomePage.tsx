...
function HomePage() {
  useEffect(() => {
    document.title = 'Ian Hirschfeld - Founder and Software Engineer';
  }, []);
      ...
      <article className="prose">
        ...
        <section>
          ...
          <p>
            ...
            brands in the world. Learn more <Link to="/about">about me and my career</Link> or take
            a deeper dive into my past <Link to="/projects">work and projects</Link>.
          </p>
        </section>

        <section>
          <h2>Something A Little More Personal</h2>
          <p>
